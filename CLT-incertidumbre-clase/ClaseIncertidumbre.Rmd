...
# Procedimiento para la evaluación y estimación según la  [](https://www.bipm.org/documents/20126/2071204/JCGM_100_2008_E.pdf/cb0ef43f-baa5-11cf-3f85-4dcd86f77bd6)
...
curva3 <- curva3[-c(661),]
curvas <- cbind(curva1,curva2[,2],curva3[,2])
colnames(curvas) <- c('Volumen de EDTA (mL)', 'pCa-1','pCa-2','pCa-3')
write.csv(curvas, 'curvasEDTA.csv', row.names = F)

```

Para ilustrar de nuevo el caso de la determinación de la incertidumbre en el punto final de la titulación, podemos cargar los datos contenidos en el archivo `curvaEDTA.csv` disponible en este [link](https://raw.githubusercontent.com/pipoelpipas/Statistics-in-R-2/main/CLT-incertidumbre-clase/curvasEDTA.csv) 
