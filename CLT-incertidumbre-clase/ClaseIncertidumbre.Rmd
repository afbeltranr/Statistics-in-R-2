...
* Para este experimento se determino la densidad de la cáscara de huevo como: $1085 \dfrac{kg}{L}$
...
for(i in 1:9){
 ...
 u_masa_CaO[[i]] <- u_masa(lectura = tabla.gravimetria$masas.promedio.CaO[i],
                          densidad = 3340,
                          balanza= 'ME204')$m_s$u_ms
}
