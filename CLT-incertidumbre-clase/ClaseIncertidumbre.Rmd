...
* $FD_{muestra}$ es el factor de dilución correspondiente a la toma de la alícuota con una pipeta de 10 mL a partir de un volumen aforado en un balón volumétrico.
*
*
*
*
...
curva <- metal_edta(conc.metal = 0.01,eqpt = TRUE)
write.csv(curva, 'curva.csv', )
